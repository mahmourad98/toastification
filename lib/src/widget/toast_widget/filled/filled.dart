...
import 'package:toastification/src/widget/toast_widget/toast_widget.dart';

class FilledToastWidget extends ToastWidget {
  ...
  @override Widget buildBody(ToastificationTheme toastTheme) {
    ...
    Widget body = Container(
      ...
      decoration: BoxDecoration(
        color: toastTheme.applyBlurEffect ? backgroundColor.withValues(alpha: 0.8) : backgroundColor,
